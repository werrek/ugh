...
class CategoryController extends AbstractController
{
     ...
     * @return Response HTTP response
     */
    #[Route('/{id}/edit', name: 'app_category_edit', requirements: ['id' => '[1-9]\d*'], methods: 'GET|PUT')]
     ...
     * @return Response HTTP response
     */
    #[Route('/{id}/delete', name: 'app_category_delete', requirements: ['id' => '[1-9]\d*'], methods: 'GET|DELETE')]
